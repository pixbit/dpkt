 ...
 */
	...
	$settings = array(
				...
				'homepage_number_of_features_columns' => 4,
		...
		<?php
			if ( is_home() && ! dynamic_sidebar( 'homepage' ) ) {
		    	...
		    	if ( 'true' == $settings['homepage_enable_features'] ) {
					$args = array( 'title' => esc_html( stripslashes( $settings['homepage_features_area_title'] ) ), 'size' => 235, 'per_row' => $settings['homepage_number_of_features_columns'], 'limit' => $settings['homepage_number_of_features'] );

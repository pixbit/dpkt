...
if ( ! function_exists( 'woocommerce_featured_products_link' ) ) {
	function woocommerce_featured_products_link() {
		?>
		<nav class="pagination woo-pagination">
			<a class="page-numbers" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>"><?php _e( 'More Products &rarr;', 'woothemes' ); ?></a>
		</nav>
		<?php
	} // End woocommerce_featured_products_link()
} // End If Statement
?>
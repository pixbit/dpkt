...
?>
  ...
  <footer id="footer"<?php if( isset( $woo_options['woo_footer_logo_enable'] ) && $woo_options['woo_footer_logo_enable'] == 'true' ) { echo ' class="with-logo"'; }?>>
    ...
    <div class="col-full">
      ...
      <?php if( isset( $woo_options['woo_footer_logo_enable'] ) && $woo_options['woo_footer_logo_enable'] == 'true' ) { ?>
    ...
    <div class="col-full bottom-bar">
			<h3>© 2015 DPKT. All rights reserved.</h3>
			<h3 class="widget-title" style="float:right;"><a href="http://www.thinkpixbit.com" style="color:white;" target="_blank">Internets Made by Pixbit</a></h3>
		</div><!-- /.col-full -->
